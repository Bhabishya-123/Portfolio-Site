        ...
        <div>
          ...
          <MySkillsCont displayValue={display}>
            ...
            <div style={{ position: "relative", display: "flex"}}>
              ...
              >
               <BrandCircle> <img src={amazon} alt="amazon pic" style={{height:'40px',objectFit:'cover',background:"white"}}/> </BrandCircle>
               ...
               <BrandCircle style={{position:"absolute",left:"50px",bottom:"-20px"}}><img src={asus} alt="twitter pic" style={{height:'21px',objectFit:'cover',background:"white"}}/></BrandCircle>
               <BrandCircle style={{position:"absolute",right:"-30px",top:"60px"}}><img src={intel} alt="intel pic" style={{height:'38px',objectFit:'cover',background:"white"}}/></BrandCircle>
              </div>
