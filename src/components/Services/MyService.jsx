    ...
    <>
      <ServiceWrapper>
        <ServiceText>
          ...
          <p>
            My primary service is frontend development and responsive design
            along with supported backend development using API's & firebase as
            well.
          </p>
          <ServiceButton style={{ marginTop: "70px" }}>
            <ButtonLink
              href={CV}
              style={{ textDecoration: "none", background: "none" }}
              download="Bhavishya_CV"
            >
              Download CV
            </ButtonLink>
          </ServiceButton>
        ...
        <ServiceCardContainer>
          ...
          >
            ...
            <h4>Design</h4>
            <p style={{ fontSize: "13px" }}>Figma, Sketch, Photoshop</p>
          ...
          >
            ...
            <p style={{ fontSize: "13px" }}>
              Html, Css, JS, React, Angular, Nodejs, Php, .NET, Mysql, Mongodb
            </p>
            <BtnP>Learn More</BtnP>
          </ServiceCard>
          <ServiceCard
            ...
            data-aos-duration="5000"
            data-aos="fade-left"
            style={{ top: "55%", left: "54%" }}
          >
            <img src={serv3} alt="service pic" />
            <h4>UI/UX</h4>
            <p style={{ fontSize: "13px" }}>
              UI design is all about visual design & user experience
            </p>
            <BtnP>Learn More</BtnP>
          </ServiceCard>
        </ServiceCardContainer>
