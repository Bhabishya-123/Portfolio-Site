    ...
    <>
      <ServiceWrapper>
        ...
        <ServiceCardContainer>
          ...
          <h4>Developer</h4>
          <p style={{fontSize:'13px'}}>Html, Css, JS, React, Angular, Nodejs, Php, .NET, Mysql, Mongodb</p>
          <BtnP>Learn More</BtnP>
          </ServiceCard>
          <ServiceCard tv={toggled} data-aos-duration='5000' data-aos="fade-left" style={{top:'55%',left:'54%'}}>
          <img src={serv3} alt="service pic" />  
          <h4>UI/UX</h4>
          <p style={{fontSize:'13px'}}>UI design is all about visual design & user experience</p>
          <BtnP>Learn More</BtnP>
          </ServiceCard>
        </ServiceCardContainer>
      </ServiceWrapper>
